...
5) Run Rails server
a) On foreground process
>> sudo rails s -b 0.0.0.0 -p 80 (0.0.0.0:80 allows wifi connection to server by name, ie: http://yonghyuns-macbook.local/)

b) In background process as daemon:
